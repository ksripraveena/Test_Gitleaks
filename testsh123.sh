...
if ! curl -o  pre-commit --fail "https://raw.githubusercontent.com/ksripraveena/Test_Gitleaks/main/testfile123"; then
    echo "Error: Failed to download pre-commit script"
    echo "  Please Check if you have access to 'https://raw.githubusercontent.com/ksripraveena/Test_Gitleaks/main/testfile123'"
    echo -e "  Git Hooks Set Up Failed \n"
    exit 1
fi
